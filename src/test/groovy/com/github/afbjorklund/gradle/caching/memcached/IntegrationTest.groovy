...
class IntegrationTest extends Specification {
    public static final int MEMCACHED_PORT = 11311 // 11211
    ...
    @Rule MemcachedService memcachedService = new MemcachedService(MEMCACHED_PORT)
    ...
    def setup() {
        ...
        testProjectDir.newFile("settings.gradle") << """
            ...
            apply plugin: $MemcachedPlugin.name

            buildCache {
                remote($MemcachedBuildCache.name) {
                    port = $MEMCACHED_PORT
                    push = true
                }
            }
